...
export declare enum FlowgladActionKey {
...
export type CustomerRetrieveBillingResponse = FlowgladNode.Customers.CustomerRetrieveBillingResponse;
export type BillingWithChecks = CustomerRetrieveBillingResponse & {
     ...
     */
    checkFeatureAccess: (featureSlug: string, refinementParams?: {
        subscriptionId?: string;
    }) => boolean;
    /**
     * @experimental
     ...
     */
    checkUsageBalance: (usageMeterSlug: string, refinementParams?: {
        subscriptionId?: string;
    }) => {
        availableBalance: number;
    } | null;
     ...
     */
    getProduct: (productSlug: string) => CustomerRetrieveBillingResponse['catalog']['products'][number] | null;
    /**
     * @experimental
     ...
     */
    getPrice: (priceSlug: string) => CustomerRetrieveBillingResponse['catalog']['products'][number]['prices'][number] | null;
};
export type SubscriptionExperimentalFields = FlowgladNode.CustomerRetrieveBillingResponse.SubscriptionItem.Experimental;
