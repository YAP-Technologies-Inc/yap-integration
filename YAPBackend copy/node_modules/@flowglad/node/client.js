...
const catalogs_1 = require("./resources/catalogs.js");
...
const prices_1 = require("./resources/prices.js");
...
const usage_meters_1 = require("./resources/usage-meters.js");
...
class Flowglad {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('FLOWGLAD_BASE_URL'), apiKey = (0, env_1.readEnv)('FLOWGLAD_SECRET_KEY'), ...opts } = {}) {
        ...
        this.catalogs = new API.Catalogs(this);
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('FLOWGLAD_LOG'), "process.env['FLOWGLAD_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Flowglad_encoder, Opts.FallbackEncoder, "f");
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.FlowgladError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Flowglad_instances, "m", _Flowglad_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Flowglad_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Flowglad = Flowglad;
...
Flowglad.Invoices = invoices_1.Invoices;
Flowglad.InvoiceLineItems = invoice_line_items_1.InvoiceLineItems;
Flowglad.Catalogs = catalogs_1.Catalogs;
Flowglad.CheckoutSessions = checkout_sessions_1.CheckoutSessions;
Flowglad.Products = products_1.Products;
Flowglad.Prices = prices_1.Prices;
Flowglad.Discounts = discounts_1.Discounts;
Flowglad.Customers = customers_1.Customers;
Flowglad.Payments = payments_1.Payments;
Flowglad.PaymentMethods = payment_methods_1.PaymentMethods;
Flowglad.Subscriptions = subscriptions_1.Subscriptions;
Flowglad.UsageEvents = usage_events_1.UsageEvents;
Flowglad.UsageMeters = usage_meters_1.UsageMeters;
