...
function Snack({
  ...
  return (
    <div
      className={clsx(
        'flex items-center gap-3 px-5 py-3 rounded-2xl shadow-lg min-w-[240px] max-w-md transition-all backdrop-blur-md border-b-2 border-r-1 border-[#e3ded3]', // <-- always applied
        {
