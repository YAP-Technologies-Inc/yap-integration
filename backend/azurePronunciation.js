...
const AZURE_KEY =
  "3QUz8EdkVk1oK0VY9DHs3RNTCL1lIOxNBcqMWYsKncKNDr2P6ezjJQQJ99BGACYeBjFXJ3w3AAAYACOGjBhM";
const REGION = "eastus";
...
async function assessPronunciation(audioPath, referenceText) {
  ...
  const res = await fetch(
    `https://${REGION}.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1?language=es-ES`,
    {
      method: "POST",
      headers: {
