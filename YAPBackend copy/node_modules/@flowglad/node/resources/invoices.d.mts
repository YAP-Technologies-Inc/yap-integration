...
export interface InvoiceCreateResponse {
     ...
     */
    invoice: InvoiceCreateResponse.PurchaseInvoice | InvoiceCreateResponse.SubscriptionInvoice | InvoiceCreateResponse.StandaloneInvoice;
    invoiceLineItems: Array<InvoiceCreateResponse.StaticInvoiceLineItem | InvoiceCreateResponse.UsageInvoiceLineItem>;
    autoSend?: boolean;
}
export declare namespace InvoiceCreateResponse {
    /**
...
export interface InvoiceRetrieveResponse {
     ...
     * determines its behavior and required fields.
     */
    invoice: InvoiceRetrieveResponse.PurchaseInvoice | InvoiceRetrieveResponse.SubscriptionInvoice | InvoiceRetrieveResponse.StandaloneInvoice;
    invoiceLineItems: Array<InvoiceRetrieveResponse.StaticInvoiceLineItem | InvoiceRetrieveResponse.UsageInvoiceLineItem>;
}
...
export interface InvoiceListResponse {
    data: Array<InvoiceListResponse.PurchaseInvoice | InvoiceListResponse.SubscriptionInvoice | InvoiceListResponse.StandaloneInvoice>;
    hasMore: boolean;
    total: number;
...
export interface InvoiceCreateParams {
     ...
     * determines its behavior and required fields.
     */
    invoice: InvoiceCreateParams.PurchaseInvoice | InvoiceCreateParams.SubscriptionInvoice | InvoiceCreateParams.StandaloneInvoice;
    invoiceLineItems: Array<InvoiceCreateParams.StaticInvoiceLineItem | InvoiceCreateParams.UsageInvoiceLineItem>;
    autoSend?: boolean;
}
...
export declare namespace Invoices {
    export { type InvoiceCreateResponse as InvoiceCreateResponse, type InvoiceRetrieveResponse as InvoiceRetrieveResponse, type InvoiceListResponse as InvoiceListResponse, type InvoiceCreateParams as InvoiceCreateParams, type InvoiceListParams as InvoiceListParams, };
}
