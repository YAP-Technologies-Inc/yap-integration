...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    fetch(`/legal/${activePage}.md`, { cache: 'no-store' })
      .then(async (r) => {
  ...
  return (
    <div className="bg-background-primary min-h-[100dvh] flex flex-col overflow-y-hidden h-[100dvh] overscroll-y-none lg:max-w-[50%] w-full mx-auto">
      ...
      <div className="relative">
        ...
        <div className="bg-background-primary rounded-b-3xl pb-4 px-4">
          <div className="text-xl font-semibold text-secondary text-center">Account</div>
          ...
          <div className="mt-4 flex items-center gap-3 ">
            ...
            <div className="flex flex-col justify-center">
              <span className="text-xl font-bold text-secondary">{name}</span>
              <span
              ...
              {created_at && (
                <span className="text-[11px] text-gray-400 mt-0.5">Joined {createdMonth}</span>
              )}
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full flex items-center justify-center overflow-hidden">
                <img src="/assets/coin.png" alt="Coin" className="w-8 h-8 object-contain" />
              </div>
      ...
      <div className="flex-1 w-full" style={{ marginTop: halfCard }}>
        <div
          className="w-full bg-white pt-10 pb-6 flex flex-col  min-h-[calc(100vh-120px)]
        lg:rounded-t-3xl
        "
        >
          <div className="rounded-2xl bg-white overflow-hidden">
            {[
              ...
              >
                ...
                {i < arr.length - 1 && <span className="absolute left-4 right-4 bottom-0 h-px" />}
              </button>
            ))}
      ...
      {activePage !== 'menu' && (
        <div className="fixed inset-0 z-[100] backdrop-blur-sm w-full mx-auto flex justify-center">
          {/* backdrop */}
          <div className="absolute inset-0" onClick={() => setActivePage('menu')} />
          {/* panel */}
          <div
            className="absolute inset-x-0 bottom-0 top-[10%] bg-background-primary rounded-t-3xl shadow-xl flex flex-col
        w-full
        lg:w-[50%] lg:left-1/2 lg:-translate-x-1/2
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5 pb-6">
              {mdLoading && <div className="text-sm text-gray-500">Loading…</div>}
              {mdError && <div className="text-sm text-red-600">Failed to load: {mdError}</div>}
              {!mdLoading && !mdError && (
